...
<?php endif; ?>
		<link type="text/css" rel="stylesheet" href="css/bootstrap/privatebin.css?<?php echo rawurlencode(
  	$VERSION,
  ); ?>" />
...
<?php if (!empty($SYNTAXHIGHLIGHTINGTHEME)): ?>
...
?>
		...
		<!-- icon -->
		<link rel="apple-touch-icon" href="<?php echo I18n::encode(
  	$BASEPATH,
  ); ?>img/apple-touch-icon.png" sizes="180x180" />
  	...
  	"Visit this link to see the note. Giving the URL to anyone allows them to access the note, too.",
		...
		<meta name="twitter:image" content="<?php echo I18n::encode($BASEPATH); ?>img/opengraph.webp" />
  	...
  	"Visit this link to see the note. Giving the URL to anyone allows them to access the note, too.",
		...
		<meta property="og:image" content="<?php echo I18n::encode($BASEPATH); ?>img/opengraph.webp" />
	...
	<div id="settingsmodal" tabindex="-1" class="modal fade" role="dialog" aria-hidden="true">
				...
				<div class="modal-content">
					<div class="modal-body">
						<form id="passwordform" role="form">
							<div class="form-group">
								<label for="passworddecrypt"><span class="glyphicon glyphicon-eye-open"></span> <?php echo I18n::_(
        	"Please enter the password for this document:",
        ); ?></label>
								<div class="input-group">
									<input id="passworddecrypt" type="password" class="form-control input-password" placeholder="<?php echo I18n::_(
         	"Enter password",
         ); ?>" required="required">
         	...
         	"Show password",
							...
							<button type="submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span> <?php echo I18n::_(
       	"Decrypt",
       ); ?></button>
						</form>
					</div>
		...
		<div id="loadconfirmmodal" tabindex="-1" class="modal fade" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="<?php echo I18n::_(
      	"Close",
      ); ?>"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title"><?php echo I18n::_(
      	"This secret message can only be displayed once. Would you like to see it now?",
      ); ?></h4>
					</div>
					<div class="modal-body text-center">
						<button id="loadconfirm-open-now" type="button" class="btn btn-success" data-dismiss="modal"><span class="glyphicon glyphicon-download"></span> <?php echo I18n::_(
      	"Yes, see it",
      ); ?></button>
					</div>
				</div>
      	...
      	"Recipient may become aware of your timezone, convert time to UTC?",
					...
					<div class="modal-body row">
						<div class="col-xs-12 col-md-6">
							<button id="emailconfirm-timezone-current" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-time"></span> <?php echo I18n::_(
       	"Use Current Timezone",
       ); ?></button>
						</div>
						<div class="col-xs-12 col-md-6 text-right">
							<button id="emailconfirm-timezone-utc" type="button" class="btn btn-success"><span class="glyphicon glyphicon-globe"></span> <?php echo I18n::_(
       	"Convert To UTC",
       ); ?></button>
						</div>
					</div>
...
<?php endif;
?>
		<nav class="navbar navbar-<?php echo $isDark ? "inverse" : "default"; ?> navbar-<?php echo $isCpct
 	? "fixed"
 	: "static"; ?>-top"><?php if ($isCpct): ?><div class="container"><?php endif; ?>
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li>
						<button id="retrybutton" type="button" class="reloadlink hidden btn btn-<?php echo $isDark
      	? "warning"
      	: "primary"; ?> navbar-btn">
							<span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> <?php echo I18n::_("Retry"),
       	PHP_EOL; ?>
						</button>
					</li>
					<li>
<?php if ($isPage): ?>
						<button id="sendbutton" type="button" class="hidden btn btn-<?php echo $isDark
      	? "warning"
      	: "primary"; ?> navbar-btn">
							<span class="glyphicon glyphicon-upload" aria-hidden="true"></span> <?php echo I18n::_("Create"),
       	PHP_EOL;else: ?>
						<button id="newbutton" type="button" class="hidden btn btn-<?php echo $isDark
      	? "warning"
      	: "default"; ?> navbar-btn">
							<span class="glyphicon glyphicon-file" aria-hidden="true"></span> <?php echo I18n::_("New"),
       	PHP_EOL;endif; ?>
						</button>
						<button id="clonebutton" type="button" class="hidden btn btn-<?php echo $isDark
      	? "warning"
      	: "default"; ?> navbar-btn">
							<span class="glyphicon glyphicon-duplicate" aria-hidden="true"></span> <?php echo I18n::_("Clone"),
       	PHP_EOL; ?>
						</button>
						<button id="rawtextbutton" type="button" class="hidden btn btn-<?php echo $isDark
      	? "warning"
      	: "default"; ?> navbar-btn">
							<span class="glyphicon glyphicon-text-background" aria-hidden="true"></span> <?php echo I18n::_(
	"Raw text",
),
       	PHP_EOL; ?>
						</button>
						<button id="downloadtextbutton" type="button" class="hidden btn btn-<?php echo $isDark
      	? "warning"
      	: "default"; ?> navbar-btn">
							<span class="glyphicon glyphicon glyphicon-download-alt" aria-hidden="true"></span> <?php echo I18n::_(
	"Save document",
),
       	PHP_EOL; ?>
						</button>
...
if ($EMAIL): ?>
						...
						<button id="emaillink" type="button" class="hidden btn btn-<?php echo $isDark
      	? "warning"
      	: "default"; ?> navbar-btn">
							<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> <?php echo I18n::_("Email"),
       	PHP_EOL; ?>
						</button>
<?php endif;
if ($QRCODE): ?>
						<button id="qrcodelink" type="button" data-toggle="modal" data-target="#qrcodemodal" class="hidden btn btn-<?php echo $isDark
      	? "warning"
      	: "default"; ?> navbar-btn">
							<span class="glyphicon glyphicon-qrcode" aria-hidden="true"></span> <?php echo I18n::_("QR code"),
       	PHP_EOL; ?>
						</button>
<?php endif;
?>
...
<?php endforeach; ?>
						...
						<a id="expiration" href="#" class="hidden dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo I18n::_(
      	"Expires",
      ); ?>: <span id="pasteExpirationDisplay"><?php echo $EXPIRE[
	$EXPIREDEFAULT
...
if ($isCpct): ?>
					<li class="dropdown">
						<a id="formatter" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo I18n::_(
      	"Options",
...
<?php endif; ?>
							...
							<li>
								<div>
									<?php echo I18n::_("Format"); ?>: <span id="pasteFormatterDisplay"><?php echo $FORMATTER[
	$FORMATTERDEFAULT
...
if ($FILEUPLOAD): ?>
					<li id="attach" class="hidden dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo I18n::_(
      	"Attach a file",
      ); ?> <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li id="filewrap">
								...
								<div id="dragAndDropFileName" class="dragAndDropFile"><?php echo I18n::_(
...
<?php endforeach; ?>
						...
						<a id="formatter" href="#" class="hidden dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo I18n::_(
      	"Format",
      ); ?>: <span id="pasteFormatterDisplay"><?php echo $FORMATTER[
	$FORMATTERDEFAULT
]; ?></span> <span class="caret"></span></a>
						<ul class="dropdown-menu">
<?php foreach ($FORMATTER as $key => $value): ?>
...
<?php if (!empty($LANGUAGESELECTION)): ?>
					<li id="language" class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-flag" aria-hidden="true"></span> <?php echo $LANGUAGES[
      	$LANGUAGESELECTION
...
<?php endif; ?>
<?php if (!empty($TEMPLATESELECTION)): ?>
					<li id="template" class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo I18n::_(
      	"Theme",
      ); ?>: <?php echo $TEMPLATESELECTION; ?> <span class="caret"></span></a>
						<ul class="dropdown-menu dropdown-menu-right">
...
<?php endif; ?>
				<div id="status" role="alert" class="clearfix alert alert-<?php
    echo (bool) $ISDELETED ? "success" : "info";
    echo empty($STATUS) ? " hidden" : "";
    ?>">
					<span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
					<?php echo I18n::encode($STATUS), PHP_EOL; ?>
					<?php if ((bool) $ISDELETED): ?>
				...
				<div id="errormessage" role="alert" class="<?php echo empty($ERROR)
    	? "hidden"
    	: ""; ?> alert alert-danger">
...
<?php endif; ?>
				<div id="pastesuccess" class="hidden">
					<div class="nav nav-justified">
						<button id="copyLink" type="button" class="btn btn-<?php echo $isDark
      	? "warning"
      	: "default"; ?> navbar-btn">
							<span class="glyphicon glyphicon-duplicate" aria-hidden="true"></span> <?php echo I18n::_(
       	"Copy link",
       ); ?>
						</button>
						<a href="#" id="deletelink" class="btn btn-<?php echo $isDark
      	? "warning"
      	: "default"; ?> navbar-btn">
...
<?php endif; ?>
				...
				<ul id="editorTabs" class="nav nav-tabs hidden">
					<li role="presentation" class="active"><a role="tab" aria-selected="true" aria-controls="editorTabs" id="messageedit" href="#"><?php echo I18n::_(
     	"Editor",
     ); ?></a></li>
					<li role="presentation"><a role="tab" aria-selected="false" aria-controls="editorTabs" id="messagepreview" href="#"><?php echo I18n::_(
     	"Preview",
     ); ?></a></li>
					<li role="presentation" class="pull-right">
<?php if ($isPage): ?>
						<button id="newbutton" type="button" class="reloadlink hidden btn btn-<?php echo $isDark
      	? "warning"
      	: "default"; ?>">
							<span class="glyphicon glyphicon-file" aria-hidden="true"></span> <?php echo I18n::_("New"),
       	PHP_EOL;else: ?>
						<button id="sendbutton" type="button" tabindex="2" class="hidden btn btn-<?php echo $isDark
      	? "warning"
      	: "primary"; ?>">
							<span class="glyphicon glyphicon-upload" aria-hidden="true"></span> <?php echo I18n::_("Create"),
       	PHP_EOL;endif; ?>
			...
			<section class="container">
				<article class="row">
					<div id="placeholder" class="col-md-12 hidden"><?php echo I18n::_(
     	"+++ no document text +++",
     ); ?></div>
		...
		<div id="serverdata" class="hidden" aria-hidden="true">
			<div id="templates">
				...
				<div id="replytemplate" class="reply hidden">
					<input type="text" id="nickname" class="form-control" title="<?php echo I18n::_(
     	"Optional nickname…",
     ); ?>" placeholder="<?php echo I18n::_("Optional nickname…"); ?>" />
					...
					<button id="replybutton" class="btn btn-default btn-sm"><?php echo I18n::_(
     	"Post comment",
     ); ?></button>
				</div>
