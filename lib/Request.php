...
class Request
{
    ...
    public function __construct()
    {
        ...
        if (array_key_exists("pasteid", $this->_params) && !empty($this->_params["pasteid"])) {
            ...
            if (
                str_contains($this->getRequestUri(), "/shortenviayourls") ||
                array_key_exists("shortenviayourls", $this->_params)
            ) {
                $this->_operation = "yourlsproxy";
            }
            if (
                str_contains($this->getRequestUri(), "/shortenviashlink") ||
                array_key_exists("shortenviashlink", $this->_params)
            ) {
