...
class TemplateSwitcherTest extends TestCase
{
    public function testSetTemplateFallback()
    {
        ...
        $defaultTemplateFallback = "bootstrap-dark";
        ...
        $this->assertEquals(
            $defaultTemplateFallback,
            TemplateSwitcher::getTemplate(),
            "Wrong bootstrap template fallback",
        );
        ...
        $this->assertEquals(
            $defaultTemplateFallback,
            TemplateSwitcher::getTemplate(),
            "Wrong template fallback",
        );

        TemplateSwitcher::setTemplateFallback($existingTemplateFallback);
        $this->assertEquals(
            $existingTemplateFallback,
            TemplateSwitcher::getTemplate(),
            "Correct template fallback",
        );
    }
    ...
    public function testSetAvailableTemplates()
    {
        ...
        $this->assertEquals(
            $availableTemplates,
            TemplateSwitcher::getAvailableTemplates(),
    ...
    public function testIsTemplateAvailable()
    {
        ...
        $this->assertTrue(
            TemplateSwitcher::isTemplateAvailable($existingTemplate),
            "Existing template",
        );
        $this->assertFalse(
            TemplateSwitcher::isTemplateAvailable($nonExistentTemplate),
